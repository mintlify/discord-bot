---
title: "Overview"
description: "Welcome to Mintlify's open-source Discord bot. With advanced modules like a management engine and a serialized ticketing system, server staff are readily equipped with
the tools they need while community members are assued they have an open line of communication and protection."
---
...
```json
{
  "staff_roles": [ // Change these IDs.
    1025454252061098024, 
    911698702685577216, 
    1026895675595702303, 
    1026889535218516008
    ], 
  "administrator_role": [ // Change these IDs.
    911698702685577216, 
    1026895675595702303, 
    1026889535218516008
    ] 
